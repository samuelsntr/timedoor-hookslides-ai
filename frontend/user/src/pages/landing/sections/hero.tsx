...
// Replace this URL with your custom hero background image link
const HERO_BG_IMAGE_URL = "https://images.unsplash.com/photo-1740750958991-19f18db5a676?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
function Hero({ onStart }: { onStart: () => void }) {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#faf7f2]">
      {/* Network Background Image & Overlay */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Soft overlay ensuring high-contrast text and warm brand feel */}
        <div className="absolute inset-0 bg-[#faf7f2]/80 backdrop-blur-[2px]" aria-hidden="true" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#faf7f2]/40 to-[#faf7f2]" aria-hidden="true" />
      </div>

      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-6 pb-20 pt-28 md:px-10 md:pb-28 md:pt-36 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          >
            Give HookSlides a topic, an article, or a YouTube link. We'll instantly generate a beautifully designed, high-converting carousel. Zero writing, designing, or formatting required.
          </p>
        ...
        <div className="relative z-10 mx-auto mt-12 w-full max-w-md lg:mt-0 lg:max-w-none">
          ...
          >
            ...
            <div
              className={`relative z-20 transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${isMounted ? 'translate-y-0 scale-100 opacity-100' : 'translate-y-12 scale-90 opacity-0'
