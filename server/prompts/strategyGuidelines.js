...
- Lead with recognizable tension, mistake, surprising contrast, or consequence — make the viewer feel understood, not baited.
...
- Do not fictionalize the source. If the source has no personal story, use an illustrative example and label it an example, not a real event.
